...
export namespace Prisma {
  ...
  */
  ...
  export type SessionGroupByArgs = {
    ...
    take?: number
    skip?: number
    count?: SessionCountAggregateInputType | true
    min?: SessionMinAggregateInputType
    max?: SessionMaxAggregateInputType
  }
  ...
  type GetSessionGroupByPayload<T extends SessionGroupByArgs> = Promise<Array<
    PickArray<SessionGroupByOutputType, T['by']> & {
      [P in ((keyof T) & (keyof SessionGroupByOutputType))]: GetScalarType<T[P], SessionGroupByOutputType[P]>
    }
  >>
  ...
  export type sessionSelect = {
    sessionId?: boolean
    dateCreated?: boolean
    sessionRestaurant?: boolean | sessionRestaurantFindManyArgs
    sessionUsers?: boolean | sessionUsersFindManyArgs
    userRestaurant?: boolean | userRestaurantFindManyArgs
  }
  ...
  export type sessionGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? Array < sessionRestaurantGetPayload<S['include'][P]>>  :
        P extends 'sessionUsers'
        ? Array < sessionUsersGetPayload<S['include'][P]>>  :
        P extends 'userRestaurant'
        ? Array < userRestaurantGetPayload<S['include'][P]>>  : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
          P extends 'sessionRestaurant'
        ? Array < sessionRestaurantGetPayload<S['select'][P]>>  :
        P extends 'sessionUsers'
        ? Array < sessionUsersGetPayload<S['select'][P]>>  :
        P extends 'userRestaurant'
        ? Array < userRestaurantGetPayload<S['select'][P]>>  : never
  } 
    : session
  : session
  ...
  export class Prisma__sessionClient<T> implements PrismaPromise<T> {
    ...
    sessionRestaurant<T extends sessionRestaurantFindManyArgs = {}>(args?: Subset<T, sessionRestaurantFindManyArgs>): CheckSelect<T, PrismaPromise<Array<sessionRestaurant>>, PrismaPromise<Array<sessionRestaurantGetPayload<T>>>>;
    ...
    userRestaurant<T extends userRestaurantFindManyArgs = {}>(args?: Subset<T, userRestaurantFindManyArgs>): CheckSelect<T, PrismaPromise<Array<userRestaurant>>, PrismaPromise<Array<userRestaurantGetPayload<T>>>>;
  ...
  export type SessionRestaurantGroupByArgs = {
    where?: sessionRestaurantWhereInput
    orderBy?: Enumerable<sessionRestaurantOrderByInput>
    by: Array<SessionRestaurantScalarFieldEnum>
    having?: sessionRestaurantScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    count?: SessionRestaurantCountAggregateInputType | true
    avg?: SessionRestaurantAvgAggregateInputType
    sum?: SessionRestaurantSumAggregateInputType
    min?: SessionRestaurantMinAggregateInputType
    max?: SessionRestaurantMaxAggregateInputType
  ...
  export type SessionRestaurantGroupByOutputType = {
    sessionId: string
    restaurantId: string
    votes: number | null
    count: SessionRestaurantCountAggregateOutputType | null
  ...
  type GetSessionRestaurantGroupByPayload<T extends SessionRestaurantGroupByArgs> = Promise<Array<
    PickArray<SessionRestaurantGroupByOutputType, T['by']> & {
      [P in ((keyof T) & (keyof SessionRestaurantGroupByOutputType))]: GetScalarType<T[P], SessionRestaurantGroupByOutputType[P]>
    }
  >>
  ...
  export interface sessionRestaurantDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    /**
     * Create many SessionRestaurants.
     *     @param {sessionRestaurantCreateManyArgs} args - Arguments to create many SessionRestaurants.
     *     @example
     *     // Create many SessionRestaurants
     *     const sessionRestaurant = await prisma.sessionRestaurant.createMany({
     *       data: {
     *         // ... provide data here
     *       }
     *     })
     *     
    **/
    createMany<T extends sessionRestaurantCreateManyArgs>(
      args?: SelectSubset<T, sessionRestaurantCreateManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    ...
    /**
     * Group by SessionRestaurant.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {SessionRestaurantGroupByArgs} args - Group by arguments.
     * @example
     * // Group by city, order by createdAt, get count
     * const result = await prisma.user.groupBy({
     *   by: ['city', 'createdAt'],
    ...
    **/
    groupBy<
      T extends SessionRestaurantGroupByArgs,
      HasSelectOrTake extends Or<
        Extends<'skip', Keys<T>>,
        Extends<'take', Keys<T>>
      >,
      OrderByArg extends True extends HasSelectOrTake
        ? { orderBy: SessionRestaurantGroupByArgs['orderBy'] }
        : { orderBy?: SessionRestaurantGroupByArgs['orderBy'] },
      OrderFields extends ExcludeUnderscoreKeys<Keys<MaybeTupleToUnion<T['orderBy']>>>,
      ByFields extends TupleToUnion<T['by']>,
      ByValid extends Has<ByFields, OrderFields>,
    ...
    >(args: SubsetIntersection<T, SessionRestaurantGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSessionRestaurantGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  /**
   * sessionRestaurant createMany
   */
  export type sessionRestaurantCreateManyArgs = {
    data: Enumerable<sessionRestaurantCreateManyInput>
    skipDuplicates?: boolean
  }
  ...
  export type SessionUsersGroupByArgs = {
    where?: sessionUsersWhereInput
    orderBy?: Enumerable<sessionUsersOrderByInput>
    by: Array<SessionUsersScalarFieldEnum>
    having?: sessionUsersScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    count?: SessionUsersCountAggregateInputType | true
    avg?: SessionUsersAvgAggregateInputType
    sum?: SessionUsersSumAggregateInputType
    min?: SessionUsersMinAggregateInputType
    max?: SessionUsersMaxAggregateInputType
  ...
  type GetSessionUsersGroupByPayload<T extends SessionUsersGroupByArgs> = Promise<Array<
    PickArray<SessionUsersGroupByOutputType, T['by']> & {
      [P in ((keyof T) & (keyof SessionUsersGroupByOutputType))]: GetScalarType<T[P], SessionUsersGroupByOutputType[P]>
    }
  >>
  ...
  export interface sessionUsersDelegate<GlobalRejectSettings> {
    ...
    **/
     ...
     *     
    **/
    createMany<T extends sessionUsersCreateManyArgs>(
      args?: SelectSubset<T, sessionUsersCreateManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, SessionUsersGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSessionUsersGroupByPayload<T> : Promise<InputErrors>
  }
   ...
   */
  export type sessionUsersCreateManyArgs = {
    data: Enumerable<sessionUsersCreateManyInput>
    skipDuplicates?: boolean
  }
  ...
  export type UserRestaurantGroupByArgs = {
    where?: userRestaurantWhereInput
    orderBy?: Enumerable<userRestaurantOrderByInput>
    by: Array<UserRestaurantScalarFieldEnum>
    having?: userRestaurantScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    count?: UserRestaurantCountAggregateInputType | true
    avg?: UserRestaurantAvgAggregateInputType
    sum?: UserRestaurantSumAggregateInputType
    min?: UserRestaurantMinAggregateInputType
    max?: UserRestaurantMaxAggregateInputType
  ...
  type GetUserRestaurantGroupByPayload<T extends UserRestaurantGroupByArgs> = Promise<Array<
    PickArray<UserRestaurantGroupByOutputType, T['by']> & {
      [P in ((keyof T) & (keyof UserRestaurantGroupByOutputType))]: GetScalarType<T[P], UserRestaurantGroupByOutputType[P]>
    }
  >>
  ...
  export interface userRestaurantDelegate<GlobalRejectSettings> {
    ...
    **/
     ...
     *     
    **/
    createMany<T extends userRestaurantCreateManyArgs>(
      args?: SelectSubset<T, userRestaurantCreateManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, UserRestaurantGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetUserRestaurantGroupByPayload<T> : Promise<InputErrors>
  }
   ...
   */
  export type userRestaurantCreateManyArgs = {
  ...
  export type sessionWhereInput = {
    ...
    sessionRestaurant?: SessionRestaurantListRelationFilter
    sessionUsers?: SessionUsersListRelationFilter
    userRestaurant?: UserRestaurantListRelationFilter
  }
  ...
  export type sessionScalarWhereWithAggregatesInput = {
    ...
    dateCreated?: DateTimeNullableWithAggregatesFilter | Date | string | null
  }
  ...
  export type sessionRestaurantWhereUniqueInput = {
    sessionId_restaurantId?: sessionRestaurantSessionIdRestaurantIdCompoundUniqueInput
  }

  export type sessionRestaurantScalarWhereWithAggregatesInput = {
    AND?: Enumerable<sessionRestaurantScalarWhereWithAggregatesInput>
    OR?: Enumerable<sessionRestaurantScalarWhereWithAggregatesInput>
    NOT?: Enumerable<sessionRestaurantScalarWhereWithAggregatesInput>
    sessionId?: StringWithAggregatesFilter | string
    restaurantId?: StringWithAggregatesFilter | string
    votes?: IntNullableWithAggregatesFilter | number | null
  }
  ...
  export type sessionUsersScalarWhereWithAggregatesInput = {
    AND?: Enumerable<sessionUsersScalarWhereWithAggregatesInput>
    OR?: Enumerable<sessionUsersScalarWhereWithAggregatesInput>
    NOT?: Enumerable<sessionUsersScalarWhereWithAggregatesInput>
    sessionId?: StringWithAggregatesFilter | string
  ...
  export type userRestaurantWhereInput = {
    ...
    vote?: IntNullableFilter | number | null
  ...
  export type userRestaurantScalarWhereWithAggregatesInput = {
    ...
    userId?: IntWithAggregatesFilter | number
    restaurantId?: StringNullableWithAggregatesFilter | string | null
    vote?: IntNullableWithAggregatesFilter | number | null
  ...
  export type sessionCreateInput = {
    ...
    sessionRestaurant?: sessionRestaurantCreateNestedManyWithoutSessionInput
    sessionUsers?: sessionUsersCreateNestedManyWithoutSessionInput
    userRestaurant?: userRestaurantCreateNestedManyWithoutSessionInput
  }

  export type sessionUncheckedCreateInput = {
    sessionId: string
    dateCreated?: Date | string | null
    sessionRestaurant?: sessionRestaurantUncheckedCreateNestedManyWithoutSessionInput
    sessionUsers?: sessionUsersUncheckedCreateNestedManyWithoutSessionInput
    userRestaurant?: userRestaurantUncheckedCreateNestedManyWithoutSessionInput
  }

  export type sessionUpdateInput = {
    sessionId?: StringFieldUpdateOperationsInput | string
    dateCreated?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    sessionRestaurant?: sessionRestaurantUpdateManyWithoutSessionInput
    sessionUsers?: sessionUsersUpdateManyWithoutSessionInput
    userRestaurant?: userRestaurantUpdateManyWithoutSessionInput
  }

  export type sessionUncheckedUpdateInput = {
    sessionId?: StringFieldUpdateOperationsInput | string
    dateCreated?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    sessionRestaurant?: sessionRestaurantUncheckedUpdateManyWithoutSessionInput
    sessionUsers?: sessionUsersUncheckedUpdateManyWithoutSessionInput
    userRestaurant?: userRestaurantUncheckedUpdateManyWithoutSessionInput
  }
  ...
  export type sessionRestaurantCreateManyInput = {
    sessionId: string
    restaurantId: string
    votes?: number | null
  }
  ...
  export type userRestaurantCreateInput = {
    restaurantId?: string | null
    vote?: number | null
    session?: sessionCreateNestedOneWithoutUserRestaurantInput
  ...
  export type userRestaurantUpdateInput = {
    ...
    session?: sessionUpdateOneWithoutUserRestaurantInput
  ...
  export type SessionRestaurantListRelationFilter = {
    every?: sessionRestaurantWhereInput
    some?: sessionRestaurantWhereInput
    none?: sessionRestaurantWhereInput
  }
  ...
  export type sessionRestaurantSessionIdRestaurantIdCompoundUniqueInput = {
    sessionId: string
    restaurantId: string
  }
  ...
  export type sessionRestaurantCreateNestedManyWithoutSessionInput = {
    create?: XOR<Enumerable<sessionRestaurantCreateWithoutSessionInput>, Enumerable<sessionRestaurantUncheckedCreateWithoutSessionInput>>
    connectOrCreate?: Enumerable<sessionRestaurantCreateOrConnectWithoutSessionInput>
    createMany?: sessionRestaurantCreateManySessionInputEnvelope
    connect?: Enumerable<sessionRestaurantWhereUniqueInput>
  }
  ...
  export type userRestaurantCreateNestedManyWithoutSessionInput = {
    create?: XOR<Enumerable<userRestaurantCreateWithoutSessionInput>, Enumerable<userRestaurantUncheckedCreateWithoutSessionInput>>
    connectOrCreate?: Enumerable<userRestaurantCreateOrConnectWithoutSessionInput>
    createMany?: userRestaurantCreateManySessionInputEnvelope
    connect?: Enumerable<userRestaurantWhereUniqueInput>
  }

  export type sessionRestaurantUncheckedCreateNestedManyWithoutSessionInput = {
    create?: XOR<Enumerable<sessionRestaurantCreateWithoutSessionInput>, Enumerable<sessionRestaurantUncheckedCreateWithoutSessionInput>>
    connectOrCreate?: Enumerable<sessionRestaurantCreateOrConnectWithoutSessionInput>
    createMany?: sessionRestaurantCreateManySessionInputEnvelope
    connect?: Enumerable<sessionRestaurantWhereUniqueInput>
  ...
  export type userRestaurantUncheckedCreateNestedManyWithoutSessionInput = {
    create?: XOR<Enumerable<userRestaurantCreateWithoutSessionInput>, Enumerable<userRestaurantUncheckedCreateWithoutSessionInput>>
    connectOrCreate?: Enumerable<userRestaurantCreateOrConnectWithoutSessionInput>
    createMany?: userRestaurantCreateManySessionInputEnvelope
    connect?: Enumerable<userRestaurantWhereUniqueInput>
  ...
  export type sessionRestaurantUpdateManyWithoutSessionInput = {
    create?: XOR<Enumerable<sessionRestaurantCreateWithoutSessionInput>, Enumerable<sessionRestaurantUncheckedCreateWithoutSessionInput>>
    connectOrCreate?: Enumerable<sessionRestaurantCreateOrConnectWithoutSessionInput>
    upsert?: Enumerable<sessionRestaurantUpsertWithWhereUniqueWithoutSessionInput>
    createMany?: sessionRestaurantCreateManySessionInputEnvelope
    connect?: Enumerable<sessionRestaurantWhereUniqueInput>
    set?: Enumerable<sessionRestaurantWhereUniqueInput>
    disconnect?: Enumerable<sessionRestaurantWhereUniqueInput>
    delete?: Enumerable<sessionRestaurantWhereUniqueInput>
    update?: Enumerable<sessionRestaurantUpdateWithWhereUniqueWithoutSessionInput>
    updateMany?: Enumerable<sessionRestaurantUpdateManyWithWhereWithoutSessionInput>
    deleteMany?: Enumerable<sessionRestaurantScalarWhereInput>
  }
  ...
  export type userRestaurantUpdateManyWithoutSessionInput = {
    create?: XOR<Enumerable<userRestaurantCreateWithoutSessionInput>, Enumerable<userRestaurantUncheckedCreateWithoutSessionInput>>
    connectOrCreate?: Enumerable<userRestaurantCreateOrConnectWithoutSessionInput>
    upsert?: Enumerable<userRestaurantUpsertWithWhereUniqueWithoutSessionInput>
    createMany?: userRestaurantCreateManySessionInputEnvelope
    connect?: Enumerable<userRestaurantWhereUniqueInput>
    ...
    update?: Enumerable<userRestaurantUpdateWithWhereUniqueWithoutSessionInput>
    updateMany?: Enumerable<userRestaurantUpdateManyWithWhereWithoutSessionInput>
    deleteMany?: Enumerable<userRestaurantScalarWhereInput>
  }

  export type sessionRestaurantUncheckedUpdateManyWithoutSessionInput = {
    create?: XOR<Enumerable<sessionRestaurantCreateWithoutSessionInput>, Enumerable<sessionRestaurantUncheckedCreateWithoutSessionInput>>
    connectOrCreate?: Enumerable<sessionRestaurantCreateOrConnectWithoutSessionInput>
    upsert?: Enumerable<sessionRestaurantUpsertWithWhereUniqueWithoutSessionInput>
    createMany?: sessionRestaurantCreateManySessionInputEnvelope
  ...
  export type userRestaurantUncheckedUpdateManyWithoutSessionInput = {
    create?: XOR<Enumerable<userRestaurantCreateWithoutSessionInput>, Enumerable<userRestaurantUncheckedCreateWithoutSessionInput>>
    connectOrCreate?: Enumerable<userRestaurantCreateOrConnectWithoutSessionInput>
    upsert?: Enumerable<userRestaurantUpsertWithWhereUniqueWithoutSessionInput>
    createMany?: userRestaurantCreateManySessionInputEnvelope
  ...
  export type sessionCreateNestedOneWithoutUserRestaurantInput = {
    create?: XOR<sessionCreateWithoutUserRestaurantInput, sessionUncheckedCreateWithoutUserRestaurantInput>
    connectOrCreate?: sessionCreateOrConnectWithoutUserRestaurantInput
    connect?: sessionWhereUniqueInput
  }
  ...
  export type sessionUpdateOneWithoutUserRestaurantInput = {
    create?: XOR<sessionCreateWithoutUserRestaurantInput, sessionUncheckedCreateWithoutUserRestaurantInput>
    connectOrCreate?: sessionCreateOrConnectWithoutUserRestaurantInput
    upsert?: sessionUpsertWithoutUserRestaurantInput
    connect?: sessionWhereUniqueInput
    disconnect?: boolean
    delete?: boolean
    update?: XOR<sessionUpdateWithoutUserRestaurantInput, sessionUncheckedUpdateWithoutUserRestaurantInput>
  }
  ...
  export type sessionRestaurantCreateManySessionInputEnvelope = {
    data: Enumerable<sessionRestaurantCreateManySessionInput>
    skipDuplicates?: boolean
  }
  ...
  export type sessionUsersCreateManySessionInputEnvelope = {
    data: Enumerable<sessionUsersCreateManySessionInput>
    skipDuplicates?: boolean
  }

  export type userRestaurantCreateWithoutSessionInput = {
    restaurantId?: string | null
    vote?: number | null
    user: userCreateNestedOneWithoutUserRestaurantInput
  }

  export type userRestaurantUncheckedCreateWithoutSessionInput = {
    userId: number
    restaurantId?: string | null
    vote?: number | null
  }

  export type userRestaurantCreateOrConnectWithoutSessionInput = {
    where: userRestaurantWhereUniqueInput
    create: XOR<userRestaurantCreateWithoutSessionInput, userRestaurantUncheckedCreateWithoutSessionInput>
  }

  export type userRestaurantCreateManySessionInputEnvelope = {
    data: Enumerable<userRestaurantCreateManySessionInput>
    skipDuplicates?: boolean
  }

  export type sessionRestaurantUpsertWithWhereUniqueWithoutSessionInput = {
    where: sessionRestaurantWhereUniqueInput
    update: XOR<sessionRestaurantUpdateWithoutSessionInput, sessionRestaurantUncheckedUpdateWithoutSessionInput>
    create: XOR<sessionRestaurantCreateWithoutSessionInput, sessionRestaurantUncheckedCreateWithoutSessionInput>
  }

  export type sessionRestaurantUpdateWithWhereUniqueWithoutSessionInput = {
    where: sessionRestaurantWhereUniqueInput
    data: XOR<sessionRestaurantUpdateWithoutSessionInput, sessionRestaurantUncheckedUpdateWithoutSessionInput>
  }

  export type sessionRestaurantUpdateManyWithWhereWithoutSessionInput = {
    where: sessionRestaurantScalarWhereInput
    data: XOR<sessionRestaurantUpdateManyMutationInput, sessionRestaurantUncheckedUpdateManyWithoutSessionRestaurantInput>
  }

  export type sessionRestaurantScalarWhereInput = {
    AND?: Enumerable<sessionRestaurantScalarWhereInput>
    OR?: Enumerable<sessionRestaurantScalarWhereInput>
    NOT?: Enumerable<sessionRestaurantScalarWhereInput>
    sessionId?: StringFilter | string
    restaurantId?: StringFilter | string
    votes?: IntNullableFilter | number | null
  }
  ...
  export type userRestaurantUpsertWithWhereUniqueWithoutSessionInput = {
    where: userRestaurantWhereUniqueInput
    update: XOR<userRestaurantUpdateWithoutSessionInput, userRestaurantUncheckedUpdateWithoutSessionInput>
    create: XOR<userRestaurantCreateWithoutSessionInput, userRestaurantUncheckedCreateWithoutSessionInput>
  }

  export type userRestaurantUpdateWithWhereUniqueWithoutSessionInput = {
    where: userRestaurantWhereUniqueInput
    data: XOR<userRestaurantUpdateWithoutSessionInput, userRestaurantUncheckedUpdateWithoutSessionInput>
  }

  export type userRestaurantUpdateManyWithWhereWithoutSessionInput = {
    where: userRestaurantScalarWhereInput
    data: XOR<userRestaurantUpdateManyMutationInput, userRestaurantUncheckedUpdateManyWithoutUserRestaurantInput>
  }
  ...
  export type sessionUsersCreateManyUserInputEnvelope = {
    data: Enumerable<sessionUsersCreateManyUserInput>
    skipDuplicates?: boolean
  }
  ...
  export type sessionCreateWithoutUserRestaurantInput = {
    sessionId: string
    dateCreated?: Date | string | null
    sessionRestaurant?: sessionRestaurantCreateNestedManyWithoutSessionInput
    sessionUsers?: sessionUsersCreateNestedManyWithoutSessionInput
  ...
  export type sessionUncheckedCreateWithoutUserRestaurantInput = {
    sessionId: string
    dateCreated?: Date | string | null
    sessionRestaurant?: sessionRestaurantUncheckedCreateNestedManyWithoutSessionInput
    sessionUsers?: sessionUsersUncheckedCreateNestedManyWithoutSessionInput
  ...
  export type sessionCreateOrConnectWithoutUserRestaurantInput = {
    where: sessionWhereUniqueInput
    create: XOR<sessionCreateWithoutUserRestaurantInput, sessionUncheckedCreateWithoutUserRestaurantInput>
  }
  ...
  export type sessionUpsertWithoutUserRestaurantInput = {
    update: XOR<sessionUpdateWithoutUserRestaurantInput, sessionUncheckedUpdateWithoutUserRestaurantInput>
    create: XOR<sessionCreateWithoutUserRestaurantInput, sessionUncheckedCreateWithoutUserRestaurantInput>
  }

  export type sessionUpdateWithoutUserRestaurantInput = {
    sessionId?: StringFieldUpdateOperationsInput | string
    dateCreated?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    sessionRestaurant?: sessionRestaurantUpdateManyWithoutSessionInput
    sessionUsers?: sessionUsersUpdateManyWithoutSessionInput
  ...
  export type sessionUncheckedUpdateWithoutUserRestaurantInput = {
    sessionId?: StringFieldUpdateOperationsInput | string
    dateCreated?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    sessionRestaurant?: sessionRestaurantUncheckedUpdateManyWithoutSessionInput
    sessionUsers?: sessionUsersUncheckedUpdateManyWithoutSessionInput
  ...
  export type sessionRestaurantCreateManySessionInput = {
    restaurantId: string
    votes?: number | null
  }
  ...
  export type userRestaurantCreateManySessionInput = {
    userId: number
    restaurantId?: string | null
    vote?: number | null
  }
  ...
  export type sessionRestaurantUncheckedUpdateManyWithoutSessionRestaurantInput = {
    restaurantId?: StringFieldUpdateOperationsInput | string
    votes?: NullableIntFieldUpdateOperationsInput | number | null
  }
  ...
  export type userRestaurantUpdateWithoutSessionInput = {
    restaurantId?: NullableStringFieldUpdateOperationsInput | string | null
    vote?: NullableIntFieldUpdateOperationsInput | number | null
    user?: userUpdateOneRequiredWithoutUserRestaurantInput
  }

  export type userRestaurantUncheckedUpdateWithoutSessionInput = {
    userId?: IntFieldUpdateOperationsInput | number
    restaurantId?: NullableStringFieldUpdateOperationsInput | string | null
    vote?: NullableIntFieldUpdateOperationsInput | number | null
  }

  export type userRestaurantUncheckedUpdateManyWithoutUserRestaurantInput = {
    userId?: IntFieldUpdateOperationsInput | number
    restaurantId?: NullableStringFieldUpdateOperationsInput | string | null
    vote?: NullableIntFieldUpdateOperationsInput | number | null
  }
